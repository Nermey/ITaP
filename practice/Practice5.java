...
public class Practice5 {
    public static void main(String[] args) { // tasks 2 6
    ...
    public static boolean sameLetterPattern(String str1, String str2) { // task1
        char[] str1Letters = str1.toCharArray();
        char[] str2Letters = str2.toCharArray();
        char changeLetter = 33; // замена буквы на символ и потом сравнение строк
    ...
    public static int digitCount(long digit) { // task 3
        if (digit < 10) {
            return 1;
        }
    ...
    public static int takeDownAverage(String[] results) { // task 6
        float resultsSum = 0;
    ...
    public static StringBuilder caesarCipher(String mode, String str, int move) { // task 7
    ...
    public static int setSetup(int n, int k) { // task 8
        if (k == 1) {
            return n;
        }
